...
document. It fixes the arm, cohort, endpoints, and decision rule before any spend.
...
(to be written) writes `paper/results/recurrence_only_ablation/{preflight.json, results.json}`; the
