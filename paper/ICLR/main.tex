...
% \iclrfinalcopy is set.  This source ships in the named preprint mode below,
% but the same ruler suppression is also used in the blind submission build, so
% the ruler-drawing macro is redefined to a no-op after the style file has
% installed its shipout hook.
% ---------------------------------------------------------------------------
