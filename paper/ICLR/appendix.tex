...
reported as such rather than rounded to match $\alpha$.
...
The current empirical gate does not yet demonstrate a useful risk--coverage
frontier at the registered 5\% level. The strongest current runs are mostly
