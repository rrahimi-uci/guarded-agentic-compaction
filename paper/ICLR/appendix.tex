...
selective risk $r_\eta$ at that threshold, because the candidate program, guard,
verifier, score, and grid were all frozen before any calibration group was
observed and admitted groups are i.i.d. Inverting the one-sided exact binomial
