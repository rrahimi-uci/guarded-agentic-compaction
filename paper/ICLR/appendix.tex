...
but does not run, the experiment that could turn \cref{sec:discussion}'s
step-like gate into a genuine risk--coverage frontier. \textbf{Status: PRE-REGISTERED,
NOT EXECUTED.} No repository beyond what this paper already reports has been
acquired under it, no provider call has been made, and no held-out case has
been selected; this appendix summarizes the committed design so it cannot be
revised in light of results it does not yet have.
