...
$1-\delta$, every $\eta\in\Lambda$ satisfies $r_\eta\le U_\eta$, where $r_\eta$
is post-dispatch group risk. Consequently the data-selected threshold
$\hat\eta$ satisfies $r_{\hat\eta}\le\alpha$ whenever $U_{\hat\eta}\le\alpha$.
\end{proposition}
