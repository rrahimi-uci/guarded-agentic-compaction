...
GAC adapts the tracing-JIT pattern---compile a hot path behind a guard and
...
They motivate workflow optimization; GAC's distinct claim is an evidence gate
...
GAC instead replaces a historical boundary only after guarded evidence.
