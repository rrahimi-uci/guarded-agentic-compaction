...
Calibration uses independent scenario groups as its statistical units: a group
is admitted if any member dispatches and violates if any dispatched member is
wrong. This conservative group risk equals episode risk in the reported live
studies, where each group is one public record.
