...
what an uncertified transfer looks like. The paper therefore still claims one
calibrated model family and reports the transfer, not a cross-model
certificate.
...
\begin{table}[t]
  ...
  protocol reports first; every other cell reproduces the calibrated model's
  structure.}
