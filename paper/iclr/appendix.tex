...
(\path{paper/results/iclr_revision/pytorch_core_recompile.json}) reproduces
...
(\path{paper/results/iclr_revision/cohort_overlap_audit.json}).
...
suite already implemented in \path{evaluation/perturb.py} (reordering,
...
(\path{paper/supplementary/drift-robustness-ablation-protocol.md}). Status:
...
\path{paper/supplementary/prospective-gate-frontier-protocol.md} pre-registers
...
provider-free \path{github_multirepo_preflight.py} harness, with at least 300
